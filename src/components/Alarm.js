...
export default class AlarmScene extends Component {
  ...
  render(){
    ...
    return(
      ...
      <Image source={require('../assets/backgroundAlarm.jpg')} style={{flex:1,height:50 }} />
      ...
      <Image source={require('../assets/Alarm_Clock.gif') } style={{width:250, height: 200,marginTop:30 }} />
      <Image source={require('../assets/push-button.gif')} style={{marginTop:-15,width:50, height: 50 }} />
      </TouchableOpacity>
      </View>
       </View>
