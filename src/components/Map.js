...
const searchIcon = (<Icon_Ion name="ios-search" size={30} color={'#fff'} style={{paddingRight: 15}} />);
...
export default class Map extends Component {
  ...
  getAllData(keyArray){
   ...
   render() {
      ...
      <View style ={styles.container}>
        ...
        <MapView
          ...
          <MapView.Marker
              ...
              <Image source={require('../assets/circular-shape.png')} style={styles.imgCircle}  />
          </MapView.Marker>
    </MapView>
    ...
    <Image source={require('../assets/alarm-clock.png')} style={styles.imgBtn} />
    </TouchableHighlight>
    
    <TouchableOpacity style={[styles.button, {top:70}]}
    onPress={()=> this.getCurrentPosition()}>
     {/* this.setState({initialPosition: this.state.markerCurrentPosition}) */}
    <Image source={require('../assets/locationBtn.png')} style={styles.imgBtn} />
    </TouchableOpacity>
